...
public class TVShows extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.activity_tvshows, container, false);
        ...
        QUERY.append("http://api.themoviedb.org/3/tv/popular?api_key=514d57fbd64c2ccaaa4aeb5c9f81c89b");
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private TVShows.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final TVShows.ClickListener clickListener) {
    ...
    private List<PopularMovieInfo> extractMovie(String jsonResp) {
        ...
        try {
            ...
            for(i=0; i<50; i++)
            {
                ...
                title = movie_item.optString("name");
